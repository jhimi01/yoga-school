...
const SingleClasses = ({yogaclass}) => {
    ...
    const {classImage,className, instructorEmail, instructorName,price,availableSeats, status, _id, Enrolled }  = yogaclass;
    ...
    return (
        <div className={`shadow-lg ${availableSeats < 1?'bg-red-400':'bg-base-300'}`}>
            ...
            <div className='text-center  pt-4'>
                <div className=''>
                    ...
                    <h4 className={`${availableSeats < 1?'bg-red-100':'bg-base-300'} text-sm text-gray-600`}>Available Seats: {availableSeats}</h4>
                </div>
